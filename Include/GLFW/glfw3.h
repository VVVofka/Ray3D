 ...
 *  systems, either when no window system is running or the program was toBase from
 ...
 *
 *  If set to `NULL`, GLFW will try to set_f the Vulkan loader dynamically by its standard
